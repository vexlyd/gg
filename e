...
tk.Label(entry_frame, text="Red", font=("Fixedsys", 12), background="#FA6C38").grid(column=0, row=2, sticky=W)
tk.Label(entry_frame, text="Blue", font=("Fixedsys", 12), background="#62A8F9").grid(column=0, row=3, sticky=W)
tk.Label(entry_frame, text="Yellow", font=("Fixedsys", 12), background="#FFBC1F").grid(column=0, row=4, sticky=W)
tk.Label(entry_frame, text="Green", font=("Fixedsys", 12), background="#01F472").grid(column=0, row=5, sticky=W)
    #-det_frame labels-#
...
Label(lead_frame, text="Red      ", font=("Fixedsys", 11), background="#FA6C38").grid(column=5, row=1, sticky=W, pady=5)
Label(lead_frame, text="Blue     ", font=("Fixedsys", 11), background="#62A8F9").grid(column=4, row=2, sticky=W, pady=5)
Label(lead_frame, text="Yellow   ", font=("Fixedsys", 11), background="#FFBC1F").grid(column=3, row=3, sticky=W, pady=5)
Label(lead_frame, text="Green    ", font=("Fixedsys", 11), background="#01F472").grid(column=2, row=4, sticky=W, pady=5)
